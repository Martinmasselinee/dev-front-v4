...
import { Brain, Presentation, Info, Share2, Globe, Linkedin, Instagram, Facebook, Plus, BarChart3, Users2, GraduationCap, DollarSign, Heart, Star, Calendar, Building2, Users } from 'lucide-react'
...
export const PersonnaliserPopup = ({ isOpen, onClose, onSave, onPersonnalisationsCountChange }: PersonnaliserPopupProps) => {
  ...
  const [centresInterets, setCentresInterets] = useState<Array<{ id: string; value: string }>>([{ id: generateId(), value: '' }])
  
  // Valeurs de la marque states
  const [valeursMarque, setValeursMarque] = useState<Array<{ id: string; value: string }>>([{ id: generateId(), value: '' }])
        ...
        >
          ...
          <FormGroup>
            ...
            <Input
              ...
              min={STRING.ZERO}
              max={INPUT_MAX.STADIUM_LOUNGE.toString()}
              step={INPUT_STEP.SMALL.toString()}
          ...
          <FormGroup>
            ...
            <Input
              ...
              placeholder={STRING.ZERO}
              min={STRING.ZERO}
              max={INPUT_MAX.SOCIAL_MEDIA.toString()}
              step={INPUT_STEP.SMALL.toString()}
              icon={<Globe size={ICON_SIZE.M} />}
            />
          </FormGroup>
          <FormGroup>
            ...
            <Input
              ...
              min={STRING.ZERO}
              max={INPUT_MAX.SOCIAL_MEDIA.toString()}
              step={INPUT_STEP.LARGE.toString()}
              icon={<Linkedin size={ICON_SIZE.M} />}
            />
          </FormGroup>
          <FormGroup>
